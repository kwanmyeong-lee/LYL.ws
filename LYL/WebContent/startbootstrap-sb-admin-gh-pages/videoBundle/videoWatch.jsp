...
<body>
	...
	<jsp:useBean id="aftervideoService"
		class="src.aftervideo.aftervideoService" scope="page"></jsp:useBean>
	...
	<header> </header>
	<iframe id="player" width="1200" height="650"
		src="http://www.youtube.com/embed/lgPi5GhEj0c?autoplay=1&mute=1"
		allowfullscreen=""></iframe>
	<p id='vidTitle'>
		title : &nbsp;<%=videoVo.getVidTitle()%></p>
	<p id='vidHits'>
		조회수
		<%=videoVo.getVidHits()%>
		회
		<%=sdf.format(videoVo.getVidDate())%></p>


	<hr>
	<p id='vidUploaderId'>
		id :&nbsp;<%=myuserVo.getUserId()%>
	</p>
	<p id='vidG'>
		구독자<%=myuserVo.getUserSub()%>
		명
	</p>

	<div class="d-grid gap-2 d-md-flex justify-content-md-end">
		<a href="" class="btn btn-primary me-md-2" type="button">구독</a> <a href="watchrecord_ok.jsp?vidno=<%=vidno %>"
			class="btn btn-primary" type="button">나중에볼 동영상</a>
	</div>
	<p id='vidContent'>
		내용 : &nbsp;<%=videoVo.getVidEx()%></p>
	<hr>
